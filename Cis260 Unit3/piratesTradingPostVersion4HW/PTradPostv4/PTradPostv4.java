...
/* in this version we modulize pirate 3
  * @author (Mr. Collard and your Thomas J. Short) 
  * @version (2017Fall) */

public class PTradPostv4
{  
    static int peiceOfEightCount = 0, pirateHatCount = 0, 
                eyePatchCount = 0, swordCount = 0,
                treasureMapCount = 0, tShirtCount = 0;
            
    static int costOfPeiceOfEight = 8, costOfHats = 32,
    ...
    }//END OF method displayUserInstructions()
    ...
    public static void calcChange(int purchaseAmount, int amountTendered )
    {
       ...
       if ((amountTendered * 128 - purchaseAmount) < 0 )
       {
        ...
        * and subtract the cost of the item*/
        int remainingAmount = (amountTendered * doubloonsToBits - purchaseAmount) ;
       ...
       if (amountTendered == 1)
       { 
           System.out.println("You gave me " + amountTendered +
