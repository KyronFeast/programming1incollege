 ...
 * 
 * @author (Mr. Collard + Thomas J. Short) 
 * @version (FA2018)
 */
public class getset_intersection
{
    //Program execution start at main
    public static void main(String[] args)
    {
        int[] setA = getUserSet();
        int[] setB = getUserSet();
        int[] setC = Intersection(setA, setB ); 
        printIntersection( setA, setB);
                  
        System.out.println("the set size is " + setC.length);
    }
    // method to get the user set
    ...
    static int[]  Intersection( int listA[], int listB[] )  
    {        // put your code here     \   
